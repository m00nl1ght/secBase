...
Route::get('/card/createemployee', 'IncomeCardController@createEmployee')->name('card-create-employee');
Route::post('/card/storeemployee', 'IncomeCardController@storeEmployee')->name('card-store-employee');
Route::post('/incomecard/update/{id}', 'IncomeCardController@update')->name('incomecard-update');
