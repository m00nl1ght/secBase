...
/* harmony import */ var _modules_autoinsert_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/autoinsert.js */ "./resources/js/modules/autoinsert.js");
/* harmony import */ var _modules_helpers_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/helpers.js */ "./resources/js/modules/helpers.js");
...
Object(_modules_helpers_js__WEBPACK_IMPORTED_MODULE_1__["inputFirstBigLetter"])(".capitalize"); //чекбоксы
...
var securityAddFormElem = document.querySelector('.js-security-add-form');

if (securityAddFormElem) {
  var securityFormItemElem = securityAddFormElem.querySelectorAll('.form-control');
  securityFormItemElem.forEach(function (elems) {
    var props = {
      ...
      insertIntoField: function insertIntoField(elem) {
        elems.value = elem.name;
      }
    };
    var autoinsert = new _modules_autoinsert_js__WEBPACK_IMPORTED_MODULE_0__["Autoinsert"](elems, props);
    autoinsert.getFocus();
...
var visitorForm = document.querySelector('.js-visitor-form');

if (visitorForm) {
  var visitorSurnameElem = visitorForm.querySelector('#visitor_surname');
  var props = {
    data: {
      "_token": token,
      "key": "name"
  ...
  var autoinsert = new _modules_autoinsert_js__WEBPACK_IMPORTED_MODULE_0__["Autoinsert"](visitorSurnameElem, props);
  autoinsert.getFocus();
  autoinsert.lostFocus();
  autoinsert.sendRequest();
...
var employeeFormItemElem = document.querySelector('#visitor_employee_surname');
...
if (employeeFormItemElem) {
  var _props = {
    ...
    insertIntoField: function insertIntoField(elems) {
  ...
  var _autoinsert = new _modules_autoinsert_js__WEBPACK_IMPORTED_MODULE_0__["Autoinsert"](employeeFormItemElem, _props);

  _autoinsert.getFocus();

  _autoinsert.lostFocus();

  _autoinsert.sendRequest();
} //автоподстановка в форму выдачи карт


var employeeCardForgetName = document.querySelector('#employee_surname');
...
if (employeeCardForgetName) {
  ...
  var _autoinsert2 = new _modules_autoinsert_js__WEBPACK_IMPORTED_MODULE_0__["Autoinsert"](employeeCardForgetName, _props2);

  _autoinsert2.getFocus();

  _autoinsert2.lostFocus();

  _autoinsert2.sendRequest();
}

var employeeBossCardForgetName = document.querySelector('#employee_boss_surname');
...
if (employeeBossCardForgetName) {
  ...
  var _autoinsert3 = new _modules_autoinsert_js__WEBPACK_IMPORTED_MODULE_0__["Autoinsert"](employeeBossCardForgetName, _props3);

  _autoinsert3.getFocus();

  _autoinsert3.lostFocus();

  _autoinsert3.sendRequest();
}

/***/ }),

/***/ "./resources/js/modules/autoinsert.js":
/*!********************************************!*\
  !*** ./resources/js/modules/autoinsert.js ***!
  \********************************************/
/*! exports provided: Autoinsert */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Autoinsert", function() { return Autoinsert; });
/* harmony import */ var _helpers_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helpers.js */ "./resources/js/modules/helpers.js");
...
var Autoinsert = /*#__PURE__*/function () {
  function Autoinsert(elems, props) {
    _classCallCheck(this, Autoinsert);
  ...
  _createClass(Autoinsert, [{
    key: "getFocus",
    value: function getFocus() {
      this.elems.addEventListener('focus', function (el) {
        var insertElem = document.createElement('ul');
    ...
    value: function lostFocus() {
      this.elems.addEventListener('blur', function () {
        setTimeout(function () {
    ...
    value: function sendRequest() {
      ...
      this.elems.addEventListener('keyup', function (el) {
        var insertIntoField = _this.insertIntoField;

        if (el.target.value.length >= 3) {
          _this.data.data = _this.elems.value;
          var parentInputField = document.querySelector('#autosubstitution');
          Object(_helpers_js__WEBPACK_IMPORTED_MODULE_0__["sendToController"])(_this.data, _this.url).then(function (response) {
            ...
            response.forEach(function (element) {
              ...
              button.type = 'button';
              button.textContent = "\n                            ".concat(element.surname ? element.surname : '', " \n                            ").concat(element.name ? element.name : '', " \n                            ").concat(element.patronymic ? element.patronymic : '', "\n                        ");
...
var sendToController = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(data, url) {
    var response, result;
  ...
  return function sendToController(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}(); //инпуты с большой первой буквы

var inputFirstBigLetter = function inputFirstBigLetter(selector) {
