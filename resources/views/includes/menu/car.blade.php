...
<li class="nav-item">
    <button class="navbar-toggler text-primary w-100" type="button" data-toggle="collapse" data-target="#navbarcar" aria-controls="navbarsExample01" aria-expanded="true" aria-label="Toggle navigation">
