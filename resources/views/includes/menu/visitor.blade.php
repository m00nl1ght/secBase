...
<li class="nav-item my-1">
    <button class="navbar-toggler text-primary w-100 px-0" type="button" data-toggle="collapse" data-target="#navbarpeople" aria-controls="navbarsExample01" aria-expanded="true" aria-label="Toggle navigation">
