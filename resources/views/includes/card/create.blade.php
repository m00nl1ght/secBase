<form action="{{ route('card-store')}}" method="post">
    ...
    <div class="form-group row">
        <label class="col-form-label col-4" for="employee_boss_surname">Руководитель сотрудника</label>
        <div class="col-2">
    ...
    <div class="form-group row">
        ...
        <div class="col-6">
            <input class="form-control" type="text" name="card_number" placeholder="Выдан пропуск №">
        </div>
    </div>
